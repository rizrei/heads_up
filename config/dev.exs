...
config :heads_up, HeadsUp.Repo,
  ...
  port: System.get_env("DATABAE_PORT") || "54328",
  stacktrace: true,
...
config :heads_up, HeadsUpWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "xnKZrstR1HdJ1h9in+fia/3/EWeYSGBKV1wBm8bJcY6NsEi7yJu1AMOV1cp1MeIj",
  watchers: [
...
config :heads_up, HeadsUpWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/heads_up_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]
